...
#define DQ_IS_IOS_LOWER_THAN_7 ( [ [ [ UIDevice currentDevice ] systemVersion ] floatValue ] < 7.0 )
#define DQ_IS_IOS_7_OR_HIGHER ( [ [ [ UIDevice currentDevice ] systemVersion ] floatValue ] >= 7.0 )
#define DQ_IS_IOS_LOWER_THAN_8 ( [ [ [ UIDevice currentDevice ] systemVersion ] floatValue ] < 8.0 )
#define DQ_IS_IOS_8_OR_HIGHER ( [ [ [ UIDevice currentDevice ] systemVersion ] floatValue ] >= 8.0 )

#define DQ_DEFAULT_ALERT_WIDTH 270
#define DQ_DEFAULT_ALERT_HEIGHT 144
...
{
    self.width = DQ_DEFAULT_ALERT_WIDTH;
    self.height = DQ_DEFAULT_ALERT_HEIGHT;
...
//    [self.cancelButton addTarget:self action:@selector(cancelButtonTouchEnded:) forControlEvents:UIControlEventTouchDragOutside];
    ...
    [self.otherButton setTitleColor:[UIColor colorWithRed:0.27 green:0.58 blue:1 alpha:1.0] forState:UIControlStateNormal];
